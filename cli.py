...
def create_shipment(file_path, key_id, api_key):
    ...
    # Создание отправки
    shipment_data['provider'] = 'canadapost' #cheapest_rate['provider']
    shipment_data['serviceCode'] = 'DOM.PC'  #cheapest_rate['serviceCode']
    ...
    log_file = {'Headers': headers, 'Request data': shipment_data, 'Response data': shipment}
    ...
    pdf_data = base64.b64decode(shipment['label'])
